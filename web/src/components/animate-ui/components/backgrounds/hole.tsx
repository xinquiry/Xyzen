...
function HoleBackground({
  ...
  const stateRef = React.useRef<any>({
    discs: [] as any[], // eslint-disable-line @typescript-eslint/no-explicit-any
    lines: [] as any[], // eslint-disable-line @typescript-eslint/no-explicit-any
    particles: [] as any[], // eslint-disable-line @typescript-eslint/no-explicit-any
    clip: {},
    startDisc: {},
    endDisc: {},
