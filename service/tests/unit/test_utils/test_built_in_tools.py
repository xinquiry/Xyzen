...
class TestBuiltInTools:
    ...
    async def test_llm_web_search_with_auth(self, mock_mcp: MagicMock) -> None:
        ...
        with (
            ...
            patch("app.middleware.auth.AuthProvider") as mock_auth_provider,
            patch("app.core.providers.get_user_provider_manager") as mock_get_manager,
            patch("app.infra.database.connection.AsyncSessionLocal") as mock_session,
        ):
            # Mock authentication
